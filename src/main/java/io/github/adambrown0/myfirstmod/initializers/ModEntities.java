...
import io.github.adambrown0.myfirstmod.client.MyfirstmodClient;
...
public class ModEntities implements Initializer {
    ...
    public void init() throws Exception {
        ...
        Set<Class<?>> classesPreCheck = new Reflections("io.github.adambrown0.myfirstmod").getTypesAnnotatedWith(ModdedMob.class);
